(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".welcome-page__slider")) new core(".welcome-page__slider", {
            ...
            if (document.querySelector(".releted-page__slider")) new core(".releted-page__slider", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 5,
            ...
            if (document.querySelector(".thumbs-product-page")) {
                const thumbsSwiper = new core(".thumbs-product-page", {
